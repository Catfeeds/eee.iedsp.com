...
if(isset($_GPC['needPage'])){
 ...
 $res = pdo_fetchall("select a.* from ".tablename('fz_dev_info')." a,".tablename('users')." b where a.username=b.username and b.levelstr like '".$devuser['levelstr']."%' order by a.id desc limit ".$startCount.",".$needCount, $condition, 'id');
