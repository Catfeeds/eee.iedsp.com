 ...
 * 版本号
 *
 * [WeEngine System] Copyright (c) 2013
 */
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="#">访问交流社区</a></li>
				</ul>
				<!--<img src="?res=logo" />-->
				<div class="logo" style="color:#EEE;font-family:cursive;">
					<!--<img src="./web/resource/images/logo/logo-lg.png" />-->
 					<h1>微信营销系统</h1>
					<h4>WECMS v1.0</h4>
				</div>
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				...
				<div class="text-center">
					Powered by <a href="/"><b>微信CMS</b></a> v1.0
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				...
				<p>
					感谢您选择微信CMS - 微信公众平台插件开源免费框架（以下简称WECMS，WECMS基于 PHP + MySQL的技术开发） <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于微信CMS系统(WECMS. 以下简称微信CMS)任何版本，微信CMS官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
				...
				<p>
					...
					<ol>
						...
						<li>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装  WECMS，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</li>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="help-block">
					<span style="color:red">若提交后报错,改成localhost再试,若是云数据库则填对应地址</span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="help-block">
					<span style="color:red">表前缀不要轻易改动,会影响模块正常使用</span>
					</div>					
				</div>
				<div class="form-group">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="help-block">
					<span style="color:red">设置成非admin更安全</span>
					</div>					
				</div>
				<div class="form-group">
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“微信营销系统”，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
	</div>
	<div class="form-group">
