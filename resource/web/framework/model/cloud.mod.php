...
define('CLOUD_GATEWAY_URL', base64_decode('aHR0cHM6Ly93YXBpLndlYmFhcHAuY29tL3dhcGkvZ2F0ZXdleTI'));
define('CLOUD_GATEWAY_URL_NORMAL', base64_decode('aHR0cDovL3dhcGkud2ViYWFwcC5jb20vd2FwaS9nYXRld2V5Mg'));
define('CLOUD_GATEAUTH_URL', 'https://api.iedsp.com/wapi/gateauth');
define('CLOUD_GATEAUTH_URL_NORMAL', 'http://api.iedsp.com/wapi/gateauth');
define('CLOUD_API_URL', base64_decode('aHR0cDovL3dhcGkud2ViYWFwcC5jb20vd2FwaS93YXBpcw'));
define('CLOUD_AGENT', base64_decode('Ng'));
