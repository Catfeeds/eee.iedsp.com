...
<!-- page 容器  -->
    <div class="page page-current" id="packageList"> 
        ...
        <header class="bar bar-nav nav_bg">
            ...
            <h1 class="title font_color_fff">第<?php  echo $level_num;?>层商户</h1> 
 ...
 function getNoteList() {
	...
	$.ajax({ 
		type: 'POST', 
		url: "index.php?c=entry&do=userList&m=fz_wlw&devid=<?php  echo $_GPC['devid'];?>&i=<?php  echo $_W['uniacid'];?>&comm=<?php  echo $commenduser;?>",
		data: {  
			paystate:paystate, 
			needPage:needPage, 
            loadPage:'findByList'
	 ...
	 function funLookLevel(level,userNmae){
		 window.location="index.php?c=entry&do=userList&m=fz_wlw&i=<?php  echo $_W['uniacid'];?>&level_num=<?php  echo $level_num;?>&comm="+userNmae;
	 }
