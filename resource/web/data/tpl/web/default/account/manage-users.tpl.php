...
<div id="js-account-manage-users" ng-controller="AccountManageUsers" ng-cloak>
	<table class="table we7-table table-hover">
		...
		<tr>
			...
			<th>权限身份</th>
			<th class="text-right">
				<?php  if($_W['isfounder'] && uni_user_see_more_info(ACCOUNT_MANAGE_NAME_VICE_FOUNDER, false)) { ?><span class="btn btn-link color-default" data-toggle="modal" data-target="#user-vice-modal">添加副创始人</span><?php  } ?>
		...
		<tr ng-repeat="permission in permissions" ng-if="permission.uid">
			...
			<td  class="we7-padding-right text-right">
				<div class="link-group">
					...
					<?php  if($_W['isfounder'] && uni_user_see_more_info(ACCOUNT_MANAGE_NAME_VICE_FOUNDER, false)) { ?><a href="javascript:;" ng-if="permission.role == 'vice_founder' && permission.isfounder == 0" ng-click="changeVice(permission.username)">修改</a><?php  } ?>
