...
<div class="clearfix we7-margin-bottom">
	<?php  if(!$_W['isfounder'] && !empty($account_info['uniacid_limit']) || user_is_vice_founder()) { ?>
		<div class="alert alert-warning">
			...
			Hi，<span class="text-strong"><?php  echo $_W['username'];?></span>，您所在的会员组： <span class="text-strong"><?php  echo $account_info['group_name'];?></span>，<?php  if(!user_is_vice_founder()) { ?>您所在的副创始人组： <span class="text-strong"><?php  echo $account_info['vice_group_name'];?></span>，<?php  } ?>
