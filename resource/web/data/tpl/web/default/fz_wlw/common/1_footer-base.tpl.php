<?php defined('IN_IA') or exit('Access Denied');?></div>
	<div class="container-fluid footer text-center" role="footer">	
		...
		<div><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="#"><b>公众平台运维系统</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
	</div>
