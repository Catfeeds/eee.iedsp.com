		...
		<div class="panel-body">
			<form class="form-horizontal" action="" method="post" id="frmSave" onsubmit="return funQuerySubmit()"> 
				...
				<div class="form-group">  
					<label for="lab" class="col-sm-2 control-label">库存预警通知模板ID</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="prewarning_notice_tpl_id" value="<?php  echo $notice_setting['prewarning_notice_tpl_id'];?>" name="prewarning_notice_tpl_id" placeholder="库存预警通知模板ID">
					</div>
				</div>

				<div class="form-group">  
					<label for="lab" class="col-sm-2 control-label">库存预警通知通知人OPENID</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="prewarning_notice_openid" value="<?php  echo $notice_setting['prewarning_notice_openid'];?>" name="prewarning_notice_openid" placeholder="库存预警通知通知人OPENID">
				...
				<div class="form-group">  
					<label for="lab" class="col-sm-2 control-label">离线通知模板ID</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="offline_notice_tpl_id" value="<?php  echo $notice_setting['offline_notice_tpl_id'];?>" name="offline_notice_tpl_id" placeholder="离线通知模板ID">
					</div>
				</div>

				<div class="form-group">  
					<label for="lab" class="col-sm-2 control-label">离线通知通知人OPENID</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="offline_notice_openid" value="<?php  echo $notice_setting['offline_notice_openid'];?>" name="offline_notice_openid" placeholder="离线通知通知人OPENID">
