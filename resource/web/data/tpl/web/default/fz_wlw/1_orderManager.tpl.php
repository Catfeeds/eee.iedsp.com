...
<ul class="nav nav-tabs">
	<li <?php  if($op == 'display') { ?>class="active"<?php  } ?> ><a href="<?php  echo url('site/entry/orderManager', array('m' => 'fz_wlw','op'=>'display'));?>">订单列表</a></li> 
	<li <?php  if($op == 'statistics') { ?>class="active"<?php  } ?>><a href="<?php  echo url('site/entry/orderManager', array('m' => 'fz_wlw','op'=>'statistics'));?>">订单图表</a></li> 
	<li <?php  if($op == 'sale_statistics') { ?>class="active"<?php  } ?>><a href="<?php  echo url('site/entry/orderManager', array('m' => 'fz_wlw','op'=>'sale_statistics'));?>">销量统计图表</a></li>
	<li <?php  if($op == 'free_statistics') { ?>class="active"<?php  } ?>><a href="<?php  echo url('site/entry/orderManager', array('m' => 'fz_wlw','op'=>'free_statistics'));?>">免费赠送统计图表</a></li>
</ul>
<?php  if($op == 'display') { ?>
<div class="clearfix">
...
<?php  } else if($op == 'sale_statistics') { ?>
<div class="clearfix">
	<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">图表</h3>
...
<?php  } else if($op == 'free_statistics') { ?>
<div class="clearfix">
	<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">图表</h3>
